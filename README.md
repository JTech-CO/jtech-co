...
# 안녕하세요. JTech Co 대표 Bryan M. 입니다

**"내가 좋아하는 일을 사업으로"**

JTech(제이택)은 이 목표 하나로 시작한 1인 콘텐츠 스튜디오입니다.  
"쉽지만 깊이 있게" 라는 원칙 아래 기술·디자인·개발 지식을 연결하는 다양한 콘텐츠를 만들고 있습니다.

- 프로그램·웹 서비스 개발
- 과학/공학 칼럼 작성 & 해외 논문/칼럼 번역
- 전자책 & 실물서 집필
- 3D 모델링 & 렌더링
- 자율주행·로봇공학 실험

여러 프로젝트를 통해 쌓은 경험과 인사이트를 기록·공유하며, 자동화 시대에도 더욱 빛나는 창의의 힘을 더 많은 사람에게 전하고 싶습니다.
...
| **Discord** | **Rare** | 🛠️ |
| **VS Code** | **Legendary** | 🛠️ |
| **Claude Code** | **Legendary** | 🧪 |
| **Antigravity** | **Legendary** | 🧪 |
| **OpenClaw** | **Rare** | 🧪 |
